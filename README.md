...
- [rtw89 USB TX flow control fix](https://github.com/Lucid-Duck/tx-resources-flow-control) — Fixed mac80211 contract violation causing packet loss under load
...
- C programming for driver modifications and bug fixes
- Wireless security testing (monitor mode, packet injection, WPA capture)
- Technical writing that doesn't waste your time
